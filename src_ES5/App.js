...
var _EmojiResults = _interopRequireDefault(require("./EmojiResults"));

var _filterEmoji = _interopRequireDefault(require("./filterEmoji"));
...
var App = /*#__PURE__*/function (_PureComponent) {
  ...
  function App(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSearchChange", function (event) {
      _this.setState({
        filteredEmoji: (0, _filterEmoji.default)(event.target.value, 20)
      });
    });

    _this.state = {
      filteredEmoji: (0, _filterEmoji.default)("", 20)
    };
    return _this;
  }
